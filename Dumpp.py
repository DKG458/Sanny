...
logo="""\033[1;36m
 ...
 [*]=============================================
    Author   : DKG458
    Facebook : https://facebook.com/ranjha
    Team     : DKG BROTHERS
    Connect  : 03424696986
 [*]=============================================
   \033[1;33m  Use (Flight) Airplane Mod For Speed Up \033[1;37m
 [*]============================================="""
wwn = pilih([U, C, B, Q])
...
class dubb:
	def __init__(self):
		...
		os.system('sort -r "'+file+'" | uniq > /sdcard/XSAHIL')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/sahilinone.txt.txt')
		os.system('rm -rf /sdcard/SAHILidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("[✓] Removing successfully ..")
		print ("[✓] Your file path : /storage/emulated/0/XSAHIL.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python Brand.py")
class login:
...
class msort:
	def __init__(self):
		...
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/XSAHIL.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/sahilinone.txt.txt')
		os.system('rm -rf /sdcard/SAHILidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
...
class sort:
	def __init__(self):
		...
		link = input ("[?] Link 1 : ")
		link1 = input ("[?] Link 2 : ")
		os.system('cat /sdcard/sahilinone.txt | grep "'+link+'" > /sdcard/1.txt')
		os.system('cat /sdcard/sahilinone.txt | grep "'+link1+'" >> /sdcard/1.txt')
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/XSAHIL.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/sahilinone.txt.txt')
		os.system('rm -rf /sdcard/SAHILidz.txt')
...
class dump_ulti:
	def __init__(self):
		...
		os.system("rm -rf /storage/emulated/0/sahilinone.txt")
		namq = ("sahilinone")
		if namq == "" or namq == " ":
